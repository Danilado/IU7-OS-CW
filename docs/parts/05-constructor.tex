...
Алгоритм регистрации серверного RFCOMM-сокета представлен на рис.~\ref{fig:module-load-scheme}.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.95\textwidth]{handler.pdf}
	\caption{Алгоритм регистрации RFCOMM сервера}
...
\begin{figure}[h!]
	...
	\caption{Алгоритм обработки движения курсора \lstinline|handle_movement|}
...
\begin{figure}[h!]
	...
	\caption{Алгоритм фонового потока отправки накопленных смещений}
...
\begin{figure}[h!]
	...
	\caption{Алгоритм формирования и отправки пакета команд \lstinline|sendPacket|}
...
\begin{figure}[h!]
	...
	\caption{Алгоритм подключения к рабочей станции \lstinline|connectToPc|}
...
Структура программного обеспечения изображена на рисунке~\ref{fig:arch}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{arch.drawio.png}
